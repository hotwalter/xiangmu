    ...
    for cell_sample in cell_sample_list:
        ...
        if "NB" in cell_path:
            ...
            if type_release == "1":
                ...
                os.system("obsutil cp -r -f {} {}".format(cell_path,chip_name,target_path))
    os.system("obsutil cp -r -f ~/software/Nanopore_Data_documentation.doc obs://nextomics6/FTP/{}/raw_data/".format(compact))
    os.system("tree -L 5 /nextomics6/FTP/{} > ./dirctory && obsutil cp -r -f dirctory obs://nextomics6/FTP/{}/".format(compact,compact))
    os.system("tree -h /nextomics6/FTP/{} > tree.txt && obsutil cp -r -f tree.txt obs://backup-nextomics-wh/Record/{}".format(compact,compact))
